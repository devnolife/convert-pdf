...
def convert_file():
    ...
    if not file.filename.lower().endswith('.docx'):
        return jsonify({'error': 'Format file tidak didukung. Harap unggah file dengan format .docx'}), 400
    ...
    try:
        ...
        return jsonify({'error': 'Konversi gagal', 'message': str(e), 'details': error_details}), 500
